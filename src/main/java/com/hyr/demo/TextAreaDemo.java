...
//	public static final String SRC = "resources/pdfs/state.pdf";
	...
	public static void main(String[] args) throws IOException, DocumentException {
		...
		new TextAreaDemo().manipulatePdf2(SRC, DEST);
	...
	class MyFooter extends PdfPageEventHelper {
		...
		public void onEndPage(PdfWriter writer, Document document) {
			...
			try {
				...
				PdfReader reader = new PdfReader("data/textarea.pdf");
				PdfStamper stamper;
				AcroFields fields;
				stamper = new PdfStamper(reader, baos);
				fields = stamper.getAcroFields();
				fields.addSubstitutionFont(baseFont);
				fields.setField("textarea",
						"保険というライブラリがあります。その中の Normalizer.normalize(\"元文字列\", Normalizer.NFKC); また、com.ibm.icu.text.Transliterator を使うと ");
