	...
	class MyFooter extends PdfPageEventHelper {
		...
		public void onEndPage(PdfWriter writer, Document document) {
			...
			try {
				...
				List<FieldPosition> bs = fields.getFieldPositions("page.count");
				...
				cb.addTemplate(total, bs.get(0).position.LEFT, bs.get(0).position.BOTTOM - 2);
...
//			if ((i++ + 1) % 3 == 0) {
//			    System.out.println(fragmentImage.getAbsoluteX() + "|" + fragmentImage.getAbsoluteY());
//				document.newPage();
//			}
		}
